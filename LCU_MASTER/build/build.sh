...
PROJECT_NAME=LCU_MASTER
EXECUTABLE=LCU_MASTER.elf
ERROR=0
start=`date +%s.%N`
...
rm -R .cmake CMakeCache.txt cmake_install.cmake Makefile CMakeFiles LCU_MASTER.map LCU_MASTER.hex &>/dev/null
