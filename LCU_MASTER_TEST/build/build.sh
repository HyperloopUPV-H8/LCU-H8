...
PROJECT_NAME=LCU_MASTER_TEST
EXECUTABLE=LCU_MASTER_TEST.elf
ERROR=0
start=`date +%s.%N`
...
rm -R .cmake CMakeCache.txt cmake_install.cmake Makefile CMakeFiles LCU_MASTER_TEST.map LCU_MASTER_TEST.hex &>/dev/null
