...
enum class MasterOrdersID : uint16_t{
	...
	TEST_INDIVIDUAL_CURRENT_CONTROL_5DOF = 335,
	TURN_ON_LATERAL_LEVITATION = 336,

	//LPU_VALIDATION
	TEST_LPU_LPU_VALIDATION = 328,
	TEST_CURRENT_LOOP_LPU_VALIDATION = 329,
	STOP_LPU_LPU_VALIDATION = 330,
	TEST_ALL_PWM_LPU_VALIDATION = 331,
	TRIGGER_ADC_CONVERSION_LPU_VALIDATION = 332,
	DISABLE_PROTECTIONS_LPU_VALIDATION = 333,
	CHANGE_FREQUENCY_LPU_VALIDATION = 334
};
...
namespace LCU{
	...
	public:
		...
		StackOrder<4, float> change_frequency_order;
		...
		IncomingOrders(Data<LPU_VALIDATION>& data) : data(data),
				...
				change_frequency_order((uint16_t)MasterOrdersID::CHANGE_FREQUENCY_LPU_VALIDATION, change_frequency_lpu_validation, &frequency)
				{}
	...
	public:
		...
		StackOrder<0> turn_on_lateral_levitation_order;
		...
		IncomingOrders(Data<VEHICLE_5DOF>& data) : data(data),
				...
				test_current_control_order((uint16_t)MasterOrdersID::TEST_INDIVIDUAL_CURRENT_CONTROL_5DOF, test_individual_current_control_5dof, &coil_target, &reference_current),
				turn_on_lateral_levitation_order((uint16_t)MasterOrdersID::TURN_ON_LATERAL_LEVITATION, turn_on_lateral_levitation)
				{
		}
