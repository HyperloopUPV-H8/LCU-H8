...
namespace LCU{
	...
	public:
		...
		StackPacket<32,float,float,float,float,float,float,float,float> slave_real_vs_reference;
		...
		Packets(Data& data): slave_reference_currents(309, &data.reference_currents[COIL_ID::HEMS_2], &data.reference_currents[COIL_ID::HEMS_4],&data.reference_currents[COIL_ID::EMS_2],&data.reference_currents[COIL_ID::EMS_4]),
			...
			slave_real_vs_reference(412,&data.coil_current_hems_2, &data.coil_current_hems_4, &data.coil_current_ems_2, &data.coil_current_ems_4, &data.reference_currents[COIL_ID::HEMS_2],&data.reference_currents[COIL_ID::HEMS_4], &data.reference_currents[COIL_ID::EMS_2], &data.reference_currents[COIL_ID::EMS_4]){}
	};
}
